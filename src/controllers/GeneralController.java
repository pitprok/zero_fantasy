...
//	@Qualifier("hsdl")
	...
	public String index(HttpSession session) {
		session.setAttribute("username", "Argon the Barbarian");
	...
	public ModelAndView advance(ModelAndView modelAndView, HttpSession session, String choice) {
		...
		if (choice.equals("A")) {
			session.setAttribute("previousChoice",((Location) session.getAttribute("location")).getFirstConsequenceText());
		} else if (choice.equals("B")) {
			session.setAttribute("previousChoice",((Location) session.getAttribute("location")).getSecondConsequenceText());
		}
